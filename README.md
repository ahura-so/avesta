...
- Causality-aware timestamping mechanism using [**hybrid logical clocks (HLC)**](https://cse.buffalo.edu/tech-reports/2014-04.pdf), making the system resilient against wall-clock skew and drift, and guaranteeing correct, causality-reflecting timestamps regardless of physical clock quirks.
