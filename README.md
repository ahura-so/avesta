...
- Causality-aware timestamping mechanism using [Hybrid Logical Clocks (HLC)](https://cse.buffalo.edu/tech-reports/2014-04.pdf), making the system resilient against wall-clock skew and drift  
