...
- Causality-aware timestamping mechanism using a [hybrid logical clock (HLC)](https://cse.buffalo.edu/tech-reports/2014-04.pdf), making the system resilient against wall-clock skew and drift, and ensuring the correct, causality-following timestamps in the face of physical clock quirks
